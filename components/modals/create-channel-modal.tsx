...
const CreateChannelModal = () => {
  ...
  return (
    <Dialog open={isOpen && type === "create-channel"} onOpenChange={handleClose}>
        ...
        <Form {...form} >
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <DialogFooter className='w-full'>
              <Button className='w-full' disabled={isLoading} variant="green" type="submit">Create channels</Button>
            </DialogFooter>
          </form>
        </Form>
