    ...
    <div>
      <ActionTooltip side='right' align='center' label='Add new Server'>
        <button className='group flex items-center' onClick={handleOpenModal}>
          <div className='flex mx-3 h-[48px] w-[48px] rounded-[25px] group-hover:rounded-[16px] transition-all overflow-hidden items-center bg-background dark:bg-neutral-700 group-hover:bg-emerald-500 justify-center'>
